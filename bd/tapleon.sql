...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 31-01-2025 a las 18:00:12
...
(39, ' asdasd', 'Av. de Álvaro López Núñez, 25, León', '987234567', 42.00000000, -5.00000000, '12:00:00', '23:30:00');
...
(13, 'L', '$2y$10$tktH0sk.uQ3iRP.BSHJhTuaSVZznmLk4w/meVurqarmtN8vbZ4Kbu', 'admin', 'l@gmail.com'),
(14, 'a', '$2y$10$ZG.j/tGHUriGjZRiWFAPhe8FPJLvWfLY49dDSLLNX2F0uM.aqK83q', 'user', 'a@gmail.com');
...
INSERT INTO `favoritos` (`id`, `id_cliente`, `id_tapa`) VALUES
(21, 13, 9),
(22, 13, 17),
(23, 13, 3),
(24, 13, 12),
...
--
ALTER TABLE `bares`
  MODIFY `id_bar` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=40;
